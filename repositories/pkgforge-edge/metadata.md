...
//Contains Additional Notes,Refs,Info the user need to be aware of, of the $PKG/$PKG_FAMILY [Otherwise Empty/Non-Existent]
note: "@string|@array",
...
<strong>//Contains the Exact Date the $PKG was Built/Fetched &#x26; Uploaded in YYYY-MM-DDTHH:MM:SS (example: 2024-10-08T01:19:56)
...
//Contains the URL to Appstream ({AppData/Metainfo}.xml) File of the $PKG/$PKG_FAMILY (MAY BE INACCURATE) [Otherwise Empty/Non-Existent]
appstream: "@string",

//Contains the $PKG/$PKG_FAMILY's Category in FreeDesktopSpec [Fallbacks to Utility]
category: "@string|@array",

//Contains the URL to .Desktop File of the $PKG/$PKG_FAMILY (MAY BE INACCURATE) [Otherwise Empty/Non-Existent]
desktop: "@string",
...
//Contains names of related binaries [COMMA SEPARATED] (Only if they belong to same $PKG_FAMILY) of the $PKG/$PKG_FAMILY [Otherwise Empty/Non-Existent]
provides: "@string",

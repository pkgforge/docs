...
* [x] This exists to explicitly define <mark style="color:orange;">**packages**</mark> that **need to be&#x20;**<mark style="color:red;">**removed**</mark>**/**<mark style="color:red;">**uninstalled**</mark>**&#x20;prior** to running <mark style="color:purple;">**`x_exec.run`**</mark>
* [x] It can contain multiple entries (<mark style="color:blue;">**CASE INSENSITIVE**</mark>, is normalized to <mark style="color:blue;">**lowercase**</mark>)

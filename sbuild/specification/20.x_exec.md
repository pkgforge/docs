...
* [x] **If used,** & the values <mark style="color:red;">**do not contain**</mark> a **valid** [<mark style="color:purple;">**`pkg_id`**</mark>](2.pkg.md) **OR** the [<mark style="color:purple;">**`pkg`**</mark>](2.pkg.md)  itself is [<mark style="color:red;">**`_disabled`**</mark>](1.shebang.md)<mark style="color:red;">**,**</mark> the **build will be aborted**. (Unless used <mark style="color:orange;">`--keep-going`</mark>)&#x20;
